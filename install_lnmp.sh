...
menu(){
	clear
	echo "######### Menu ########"
	echo "Enter 1 install nginx"
	echo "Enter 2 install mysql"
	echo "Enter 3 install php"
	echo "Enter 4 exit install program !"
	echo "######### End #########"
	}
choice(){
	read -p "please enter choice: " select 
	}
...
while true;do
	...
	case select in
		...
		4)	
			...
			;;
		*)
			echo "select error! please choice again."
			;;
		esac
done
